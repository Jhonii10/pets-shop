...
const PETS_LIST = [
  ...
  { id: 8, pet: 'Dalmata', createAt: '2023-07-30', price: '520,000', stock: 7, imageUrl:'https://images.pexels.com/photos/3763311/pexels-photo-3763311.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'  },
...
export const PetsApp = () => {
  ...
  return (
    ...
    <Container>
        ...
        <Card>
            <PetsListToolbar filterName={filterName} onFilterName={handleFilterByName} arr={PETS_LIST}/>
            <ScrollBar>
